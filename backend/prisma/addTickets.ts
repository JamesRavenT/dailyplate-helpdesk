...
function msgId(n: number) {
  return `<add-msg-${n.toString().padStart(4, '0')}-${Date.now()}@dailyplate.example>`
}
...
const tickets = [
  // ── ACCOUNT ──────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 'h.allen@example.com',
  ...
  },
  {
    ...
    customer_email: 't.barnes@example.com',
  ...
  // ── DELIVERY ─────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 'g.okafor@example.com',
  ...
  },
  {
    ...
    customer_email: 'f.mccarthy@example.com',
  ...
  },
  {
    ...
    customer_email: 'i.craig@example.com',
  ...
  },
  {
    ...
    customer_email: 'r.dupont@example.com',
  ...
  // ── TECHNICAL ────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 'n.fleming@example.com',
  ...
  },
  {
    ...
    customer_email: 'a.sinclair@example.com',
  ...
  },
  {
    ...
    customer_email: 'm.thornton@example.com',
  ...
  // ── PAYMENT ──────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 'e.watts@example.com',
  ...
  },
  {
    ...
    customer_email: 'p.lawson@example.com',
  ...
  },
  {
    ...
    customer_email: 'c.nguyen@example.com',
  ...
  // ── VOUCHER ──────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 's.horton@example.com',
  ...
  },
  {
    ...
    customer_email: 'o.lindqvist@example.com',
  ...
  // ── MENU ─────────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 'v.marsh@example.com',
  ...
  },
  {
    ...
    customer_email: 'k.paterson@example.com',
  ...
  },
  {
    ...
    customer_email: 'l.fitzgerald@example.com',
  ...
  },
  {
    ...
    customer_email: 'e.nakamura@example.com',
  ...
  // ── INQUIRY ──────────────────────────────────────────────────────────────
  {
    ...
    customer_email: 's.coleman@example.com',
  ...
  },
  {
    ...
    customer_email: 'r.adeyemi@example.com',
  ...
  },
  {
    ...
    customer_email: 'w.blackwood@example.com',
  ...
  },
  {
    ...
    customer_email: 'p.reid@example.com',
  ...
  },
  {
    ...
    customer_email: 'a.brennan@example.com',
  ...
  },
  {
    ...
    customer_email: 'm.king@example.com',
  ...
  },
  {
    ...
    customer_email: 'i.walsh@example.com',
